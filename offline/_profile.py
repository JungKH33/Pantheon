...
if __name__ == '__main__':
    ...
    parser.add_argument('--host', type=str, default='192.168.0.27')
    parser.add_argument('--port', type=int, default= 9999)
    parser.add_argument('--buffer', type=int, default=1024 * 1024)
    parser.add_argument('--data_dir', type=str, default=r"F:\Projects\CPP\Pantheon-main\Pantheon_Datasets_Models\0_Datasets")
